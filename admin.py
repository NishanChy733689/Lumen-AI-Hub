...
def render_login_view():
    ...
    with center_col:
        ...
        st.title("Lumen AI hub Admin Portal")
        ...
        with tab_login:
            ...
            pass_field = st.text_input("Password:", type="password", key="login_pass").strip()
        ...
        with tab_register:
            ...
            reg_pass = st.text_input("Set Access Password:", type="password", key="reg_pass").strip()
